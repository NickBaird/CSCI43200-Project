     ...
     -->
		...
		>
			...
			<div
				...
				class="z-20 absolute top-full bg-white  p-5 m-2 rounded-md drop-shadow-md flex flex-col items-center justify-center text-xl  gap-2 "
			>
		...
		<div class="h-full flex items-center text-xl font-bold">
			<router-link :to="{ name: 'auth' }">
				<button
					type="button"
					class="cursor-pointer text-[#EDF4ED] bg-blue-500 rounded-md px-4 py-2"
				>
					Login or Signup
				</button>
			</router-link>
